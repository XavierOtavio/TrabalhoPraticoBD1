<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="SeuProjeto.Account.Login" %>
...
<body class="bg-light">
    <form id="form1" runat="server" class="container d-flex justify-content-center align-items-center vh-100">
        <div class="card p-4 shadow-sm" style="width: 350px;">
            ...
            <asp:Button ID="ButtonLogin" runat="server" Text="Entrar" CssClass="btn btn-primary w-100" OnClick="ButtonLogin_Click" />
